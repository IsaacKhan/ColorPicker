...
class COLOR_PICKER_DATA_PROVIDER: ViewModel() {
    ...
    val grid_color_list = listOf(
        // White to Black
        "#FFFFFF", "#EEEEEE", "#CCCCCC", "#BBBBBB", "#AAAAAA", "#999999", "#888888", "#777777", "#666666", "#333333", "#111111",  "#000000",

        // Darker
        "#009696", "#000096", "#800096", "#960096", "#960000", "#968000", "#96C500", "#96D500", "#969600", "#809600", "#009600",  "#009680",
        "#00AFAF", "#0000AF", "#8000AF", "#AF00AF", "#AF0000", "#AF8000", "#AFC500", "#AFD500", "#AFAF00", "#80AF00", "#00AF00",  "#00AF80",
        "#00C8C8", "#0000C8", "#8000C8", "#C800C8", "#C80000", "#C88000", "#C8C500", "#C8D500", "#C8C800", "#80C800", "#00C800",  "#00C880",
        "#00E6E6", "#0000E6", "#8000E6", "#E600E6", "#E60000", "#E68000", "#E6C500", "#E6D500", "#E6E600", "#80E600", "#00E600",  "#00E680",

        //   Cyan,      Blue,    Purple,      Pink,       Red,    Orange, Y. Orange,      Gold,    Yellow,  Y. Green,     Green,  Sea Green,
        "#00FFFF", "#0000FF", "#8000FF", "#FF00FF", "#FF0000", "#FF8000", "#FFC500", "#FFD500", "#FFFF00", "#80FF00", "#00FF00",  "#00FF80",

        // Lighter
        "#64FFFF", "#6464FF", "#8064FF", "#FF64FF", "#FF6464", "#FF8064", "#FFC564", "#FFD564", "#FFFF64", "#80FF64", "#64FF64",  "#64FF80",
        "#7DFFFF", "#7D7DFF", "#807DFF", "#FF7DFF", "#FF7D7D", "#FF807D", "#FFC57D", "#FFD57D", "#FFFF7D", "#80FF7D", "#7DFF7D",  "#7DFF80",
        "#96FFFF", "#9696FF", "#8096FF", "#FF96FF", "#FF9696", "#FF8096", "#FFC596", "#FFD596", "#FFFF96", "#80FF96", "#96FF96",  "#96FF80",
        "#AFFFFF", "#AFAFFF", "#80AFFF", "#FFAFFF", "#FFAFAF", "#FF80AF", "#FFC5AF", "#FFD5AF", "#FFFFAF", "#80FFAF", "#AFFFAF",  "#AFFF80",
    )
    ...
    fun setReadOnly(color_to_update: Int, read_only: Boolean){
        viewModelScope.launch {
            when(color_to_update){
                1 -> { redReadOnly = read_only }
                2 -> { greenReadOnly = read_only }
                3 -> { blueReadOnly = read_only }
            }
        }
    }
    ...
    fun updateColorListToDisplay(){
        viewModelScope.launch {
            ...
            colorListToDisplay.value = savedColorSet.value.chunked(COLORS_PER_PAGE)[visiblePageIndex]
